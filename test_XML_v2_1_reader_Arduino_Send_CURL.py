...
def main():
    ...
    system("curl -v -k --header 'Content-Type: text/xml;charset=UTF-8' --header 'SOAPAction:http://tempuri.org/IImporterWebService/ProcessRequest' --data @whitelist.xml http://172.27.140.95:5000/ImporterWebService")
